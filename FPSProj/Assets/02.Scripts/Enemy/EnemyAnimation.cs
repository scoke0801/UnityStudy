...
namespace Enemy
{
    public class EnemyAnimation : MonoBehaviour
    {
        ...
        void NavAnimSetup()
        {
            ...
            // 플레이어를 향하려 할 떄 깜빡 거리지 않도록 데드존 각도를 적용.
        ...
        private void LateUpdate()
        {
            if (controller.Aiming)
            {
                ...
                // 엉덩이를 기준으로 척추 회전이 60 도이하인 경우는 계속 조준이 가능.
            ...
            else
            {
                ...
                // 조준 중이 아니면 원래 offset 각도로 점차 돌아가도록.
